...
void main() {
  ...
  {
    group(
        'Testing the Implemented Repository by checking thee network info', () {
      ...
      group('Offline actions', () {
        ...
        test(
            'getAllProduct Should return valid list of ProductEntity', () async {
          /// arrange
          when(
          ...
          expect(result,  Right(ProductModel.allToEntity(TestingDatas.productModelList)));
        });


        test('Should call the network method and return appropriate data', () async {
          /// arrange
          when(
